...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (Params().NetworkID() == CBaseChainParams::TESTNET) {
        ...
        if (nHeight >= 67000)
        {
            return 500 * COIN; //testnet is fun
        }
        return 100 * COIN;
    }

    if (nHeight == 0) {
        nSubsidy = 152000000 * COIN;
    }   else if (nHeight <= 262800 && nHeight > 0) {
        nSubsidy = 300 * COIN;
	...
	}   else if (nHeight <= 2102400 && nHeight > 1051200) {
        nSubsidy = 25 * COIN;
		
	}   else if (nHeight <= 4204800 && nHeight > 2102400) {
        nSubsidy = 12.5 * COIN;
		
	}   else if (nHeight <= 8409600 && nHeight > 4204800) {
        nSubsidy = 6.25 * COIN;
		
	}   else if (nHeight <= 16819200 && nHeight > 8409600) {
        nSubsidy = 3.125 * COIN;
